...
const EREGISTER_COLUMNS = {
  ...
  client_name: { x: 450, width: 175 },    // 450-625 (Name of Client) — left edge
                                          // lowered to 450 so long, centre-aligned
                                          // company names (which begin as far left
                                          // as x=454, e.g. "SHRIJEE PAPER MILLS",
                                          // "CHAIRMEN/SECRETARY …") aren't dropped.
